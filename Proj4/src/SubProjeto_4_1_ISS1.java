...
public class SubProjeto_4_1_ISS1 {
    public static void main(String[] args) {
        ArrayList<Integer> numeros = receberDados();

        improvedShellSort1(numeros);
    ...
    public static void improvedShellSort1(ArrayList<Integer> numeros) {
        ArrayList<Integer> gaps = new ArrayList<>();
        int aux1;
        int aux2 = 1;
        while ((aux1 = (int) (Math.pow(2,aux2)-1)) < numeros.size()) {
            gaps.add(aux1);
            aux2++;
        }
